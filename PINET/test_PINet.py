...
def init_testing():
    ...
    ##############################
    print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
    print("Loading PINET, Lane Detection Model")
    if p.model_path == "":
...
def Testing(lane_agent, img):
    test_image = img / 255.0
    test_image = np.rollaxis(test_image, axis=2, start=0)
    w_ratio = 1.0
    h_ratio = 1.0
    in_x, in_y, ti = test_ori(lane_agent, img, np.array([test_image]), w_ratio, h_ratio, draw_type='point',
...
############################################################################
def test_ori(lane_agent, ori_image, test_images, w_ratio, h_ratio, draw_type,
